...
I concetti chiave alla base del paradigma FRP sono i due tipi di dato \textit{Behavior} e \textit{Event}, ognuno dei quali con i propri combinatori:
\begin{description}
    \item[Behavior] - Modella valori che variano nel tempo.
    \item[Event] - Modella un sequenza di eventi in ordine cronologico.
\end{description}
